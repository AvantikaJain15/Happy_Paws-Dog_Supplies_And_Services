...
<section class="products">
   ...
   <div class="box-container box-container-common">
      <?php  
...
<section class="services">
   ...
   <div class="box-container box-container-common">
      ...
      <input type="number" min="1" name="product_quantity" value="1" class="qty">
      <input type="hidden" name="product_name" value="<?php echo $fetch_services['name']; ?>">
      <input type="hidden" name="product_price" value="<?php echo $fetch_services['price']; ?>">
      <input type="hidden" name="product_image" value="<?php echo $fetch_services['image']; ?>">
      <input type="submit" value="add to cart" name="add_to_cart" class="btn">
     </form>
      <?php
         }
